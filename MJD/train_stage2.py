...
"""
Train Stage 2 posterior update network for the MJD model.
Inputs: grouped option_features, option_prices, and priors.
Target: true MJD parameters [mu, sigma, lambda, mu_J, sigma_J].
"""
...
class Stage2MJDDataset(Dataset):
    def __init__(self, data_path):
        ...
        self.P = self.priors.shape[1]  # 5 for MJD
