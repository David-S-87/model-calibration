# Heston/train_stage2.py

"""
Train Stage 2 posterior update network for the Heston model.
Inputs: grouped option_features, option_prices, and priors.
Target: true Heston parameters [mu, v0, theta, kappa, sigma_v, rho].
"""
...
class Stage2HestonDataset(Dataset):
    def __init__(self, data_path):
        ...
        self.P = self.priors.shape[1]  # 6 for Heston
...
def main():
    ds     = Stage2HestonDataset(DATA_PATH)
