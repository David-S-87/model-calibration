...
"""
Evaluate the Stage 1 Heston model on the training set.
...
CHECKPOINT_PATH = r"C:\Users\david\BathUni\MA50290_24\model_calibration\Heston\checkpoints\stage1_heston_model.pth"
...
def main():
    ...
    y_true = data["true_params"]  # shape (N, 6)
    ...
    # --- Plotting ---
    labels = ["mu", "v0", "theta", "kappa", "sigma_v", "rho"]
