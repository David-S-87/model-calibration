...
"""
Add priors to Stage 2 dataset for Heston model using trained Stage 1 network.
...
MODEL_NAME       = "Heston"
N_PARAMS         = 6
CHECKPOINT_PATH  = project_root / "Heston" / "checkpoints" / "stage1_heston_model.pth"
STAGE1_DATA_PATH = project_root / "data" / "synthetic_data1" / "Heston" / "stage1_heston_dataset.npz"
STAGE2_DATA_PATH = project_root / "data" / "synthetic_data2" / "Heston" / "stage2_heston_dataset.npz"
OUTPUT_PATH      = project_root / "data" / "synthetic_data2" / "Heston" / "grouped_stage2_heston.npz"
