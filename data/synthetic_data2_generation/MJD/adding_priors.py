...
"""
Add priors to Stage 2 dataset for MJD model using trained Stage 1 network.
...
MODEL_NAME       = "MJD"
N_PARAMS         = 5
CHECKPOINT_PATH  = project_root / "MJD" / "checkpoints" / "stage1_mjd_model.pth"
STAGE1_DATA_PATH = project_root / "data" / "synthetic_data1" / "MJD" / "stage1_mjd_dataset.npz"
STAGE2_DATA_PATH = project_root / "data" / "synthetic_data2" / "MJD" / "stage2_mjd_dataset.npz"
OUTPUT_PATH      = project_root / "data" / "synthetic_data2" / "MJD" / "grouped_stage2_mjd.npz"
...
def load_summary_stats():
    ...
    # assume summary_stats stacked in same order as set_ids
