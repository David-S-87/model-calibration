...
"""
Evaluate the Stage 1 GBM model on the training set.
...
from common import get_stage1_network  # assumes it's already trained

DATA_PATH = r"C:\Users\david\BathUni\MA50290_24\model_calibration\data\synthetic_data1\GBM\stage1_gbm_dataset.npz"
CHECKPOINT_PATH = r"C:\Users\david\BathUni\MA50290_24\model_calibration\GBM\checkpoints\stage1_gbm_model.pth"
...
def main():
    ...
    y_true = data["true_params"]  # shape (N, 2)
    ...
    for i in range(2):
        ...
        plt.grid()
        plt.tight_layout()
        plt.savefig(f"{labels[i]}_true_vs_pred.png")
        print(f"Saved plot: {labels[i]}_true_vs_pred.png")
