...
"""
Evaluate the Stage 1 Bates model on the training set.
...
CHECKPOINT_PATH = r"C:\Users\david\BathUni\MA50290_24\model_calibration\Bates\checkpoints\stage1_bates_model.pth"
...
def main():
    ...
    y_true = data["true_params"]  # shape (N, 9)
    ...
    # --- Plotting ---
    labels = ["mu", "v0", "theta", "kappa", "sigma_v", "rho", "lambda", "mu_J", "sigma_J"]
